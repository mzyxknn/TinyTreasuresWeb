...
export default function Home() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer:
        "Our online store is always open! Customer service is available Monday-Friday, 9am-5pm (PHT).",
    },
  ];
    ...
    <>
      ...
      <div className="px-4 md:px-12 lg:px-16 xl:px-20">
        <main>
          ...
          <section
            id="home"
            className="relative py-12 sm:py-16 lg:py-20 min-h-[600px] flex items-center"
          >
              ...
              <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
                <div className="space-y-4 order-1">
                  ...
                  <p className="max-w-[600px] text-gray-600 text-base md:text-lg lg:text-xl font-medium text-center lg:text-left mx-auto lg:mx-0">
                    Handcrafted photo products, keychains, pins, and more. Turn
                    your special moments into treasured keepsakes.
                  </p>
              ...
              <div className="container px-4 mx-auto md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center mb-12">
                  ...
                  <p className="max-w-[700px] text-gray-600 md:text-xl">
                    Discover our most popular and trending designs
                  </p>
                </div>
              ...
              <div className="container px-4 mx-auto md:px-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                    ...
                    <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 relative group cursor-pointer">
                      ...
                      <p className="text-gray-600 leading-relaxed">
                        Cute and expressive button pins featuring adorable
                        winkie designs. Perfect for adding personality to your
                    ...
                    <div className="bg-white/50 backdrop-blur-sm rounded-2xl p-8 shadow-lg transition-all duration-300 relative opacity-75">
                      ...
                      <p className="text-gray-400 leading-relaxed">
                        We&apos;re working on something special for you! Stay
                        tuned for our next amazing product that will add even
                        more magic to your memories.
                      </p>
                      <div className="mt-6 flex items-center justify-between">
                        <span className="font-bold text-gray-400 text-lg md:text-2xl">
                          TBA
                        </span>
                        <Button
                          disabled
                ...
                <div className="mt-16 bg-white/90 backdrop-blur-sm rounded-lg p-6 shadow-lg">
                  ...
                  <p className="mt-2 text-gray-600">
                    Looking for something personalized? We can create custom
                    items just for you!
                  </p>
                ...
                <div className="grid gap-12 lg:grid-cols-2 items-center">
                  <div className="space-y-4">
                    ...
                    <p className="text-gray-600 text-center lg:text-left mx-auto lg:mx-0">
                      Tiny Treasures was founded with a simple mission: to help
                      people preserve their precious memories in beautiful,
                      tangible ways. What started as a hobby has grown into a
                      passion for creating high-quality, handcrafted photo
                      products.
                    </p>
                    <p className="text-gray-600 text-center lg:text-left mx-auto lg:mx-0">
                      Every item we create is made with care and attention to
                      detail. We believe in sustainable practices and use
            ...
            <section id="contact" className="py-16 relative z-20">
              <div className="container px-4 mx-auto md:px-6">
                <div className="flex flex-col items-center justify-center space-y-4 text-center">
                  ...
                  <p className="max-w-[700px] text-gray-600 md:text-xl">
                    Have questions or want to place a custom order? Reach out to
                    us!
                  </p>
                </div>
